...
## Kỹ nghệ Dữ liệu & ETL (Data Engineering & ETL)
- Financial ETL Pipelines (Đường ống ETL tài chính)
- Data Scraping & Ingestion (Thu thập và nạp dữ liệu tự động)
- Stream In-memory Processing (Xử lý luồng trong bộ nhớ đệm - io.BytesIO)
- Relational Database Schema Design (Thiết kế cơ sở dữ liệu quan hệ)
- Tối ưu hóa truy vấn SQL
- Data Cleansing & Normalization (Làm sạch và chuẩn hóa dữ liệu)

## Tài chính Định lượng & Mô hình hóa Rủi ro (Quantitative & ML Risk Modeling)
- Credit Risk Default Forecasting (Dự báo vỡ nợ tín dụng)

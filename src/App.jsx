                        ...
                        <div>
                            ...
                            <div className="mt-5">
                                <PDFDownloadLink 
                                    ...
                                    className="inline-flex items-center gap-2 px-5 py-2 bg-[#0A9396] hover:bg-[#087f81] text-white text-sm font-bold rounded-lg transition-colors shadow shadow-[#0A9396]/30"
                                >

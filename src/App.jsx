        ...
        en: {
            ...
            experience: {
                ...
                job1: {
                    ...
                    bullets: [
                        "Spearheaded <strong>AI-driven market intelligence</strong> leveraging Gemini Deep Research to deconstruct value chains and business models of 8 global listed UAV companies.",
        ...
        vi: {
            ...
            experience: {
                ...
                job1: {
                    ...
                    bullets: [
                        "Tiên phong ứng dụng <strong>Trí tuệ thị trường (Market Intelligence)</strong> dựa trên AI (Gemini Deep Research) để giải mã chuỗi giá trị và mô hình kinh doanh của 8 công ty UAV niêm yết toàn cầu.",
